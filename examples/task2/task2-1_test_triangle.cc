...
int main(int argc, char* argv[])
{
    ...
    A(0, 0) = A1[0];    A(0, 1) = A1[1];    A(0, 2) = A1[2];    A(0, 3) = A1[3];
    A(1, 0) = A2[0];    A(1, 1) = A2[1];    A(1, 2) = A2[2];    A(1, 3) = A2[3];
    A(2, 0) = A3[0];    A(2, 1) = A3[1];    A(2, 2) = A3[2];    A(2, 3) = A3[3];
    A(3, 0) = A4[0];    A(3, 1) = A4[1];    A(3, 2) = A4[2];    A(3, 3) = A4[3];
